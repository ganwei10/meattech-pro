  ...
  <p style="margin-top:16px;">感谢您使用 MeatTech Pro 智能中试平台！</p>
    ...
    const homepageSettings = [
      { key: 'homepage_carousel', value: JSON.stringify([
        { tag: '商超爆款逆向工程', title: '山姆某款爆汁脆皮肠', desc: '从"货架到车间"的工业化落地工艺参数拆解，涵盖原料配比、灌装工艺、蒸煮曲线全流程', bg: 'carousel-bg-1', btn: '点击查看工艺说明书及基础配方', link: '/admin/products' },
      ...
      { key: 'homepage_industry', value: JSON.stringify([
        { icon: '🔬', tag: '辅料应用', tagBg: '#FEF3C7', tagColor: '#92400E', title: '复配磷酸盐在低温火腿中的保水优化方案', desc: '对比三聚磷酸钠、六偏磷酸钠及其复配方案在低温火腿中的保水效果，涵盖pH调节、蛋白质溶解度、质构分析等关键指标。' },
        { icon: '⚙️', tag: '机械选型', tagBg: '#DBEAFE', tagColor: '#1E40AF', title: '汇川/西门子 PLC 控制系统在现代化高速斩拌机中的温度精准控制实践', desc: '对比汇川H3U系列与西门子S7-1200在高速斩拌机（6000rpm）刀盘温度闭环控制中的响应精度与稳定性表现，涵盖PID参数整定方法。' },
