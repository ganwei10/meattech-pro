...
export async function GET() {
  ...
  <p style="margin-top:16px;">感谢您使用 MeatTech Pro 智能中试平台！</p>
    ...
    const homepageSettings = [
      ...
      { key: 'site_global', value: JSON.stringify({
        header: {
        ...
        tools: {
          gb2760: { title: '📊 GB 2760 添加剂限量计算器', subtitle: '输入添加剂名称查询最大使用量，并计算实际用量合规性', disclaimer: '⚠️ 本计算器数据基于 GB 2760-2014《食品安全国家标准 食品添加剂使用标准》，仅供参考。实际生产请以最新国标原文为准，并结合产品具体类别确认适用限量。' },
          troubleshoot: { title: '🚨 车间故障智能排查矩阵', subtitle: '10分钟快速排查出水、出油、散碎、色泽等常见肉制品生产故障' },
          pilotMap: { title: '🗺️ 全国肉类共享中试产线地图', subtitle: '在线预约闲置产能，轻资产研发', mapIntro: '覆盖全国主要区域的肉类中试资源网络，每区域均面向三类客户服务：高校科研院所（CRO研发）、产业园公共平台（轻资产试错）、辅料企业演示中心（风味调优与爆款逆向）。' },
        },
        booking: { title: '中试产线预约', subtitle: '提交您的中试需求，平台专家将在24小时内1对1跟进' },
        community: { headerBadge: '💬 工艺问答社区', headerTitle: '疑难杂症讨论交流', headerDesc: '遇到工艺难题？发帖求助，同行专家来解答。出水、散肉、色泽不均、保质期不达标……这里都有答案。', askBtnText: '✏️ 我要提问' },
        homepage: {
          toolCards: [
          ...
          pilotDemo: { title: '🎛️ 远程协同研发舱（数据孪生演示）', liveLabel: '正在进行：真空滚揉放大实验', liveLocation: '华南区·华南理工中试基地', chatText: '远程指挥 · 张总监：料温已到4℃，开始加胶体，注意控制添加速率在0.5kg/min以内' },
