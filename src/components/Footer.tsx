      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div>
            ...
            <Link href="/partner" style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', marginTop: '12px', background: 'rgba(255,255,255,0.12)', padding: '8px 18px', borderRadius: '20px', color: '#fff', fontSize: '.85rem', fontWeight: 600, cursor: 'pointer', textDecoration: 'none', transition: 'background .2s' }}>申请入驻成为服务商 →</Link>
          </div>
        </div>
